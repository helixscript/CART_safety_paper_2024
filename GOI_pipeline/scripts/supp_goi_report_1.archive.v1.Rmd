...
title: |
    ...
    | All Patients (CLL & ALL) and 
    | Response Groups (CR/PRtd & PR/NR)
output: 
  pdf_document:
...
if(!exists('scriptDir')) {scriptDir <- "/home/ubuntu/data/CART19/CART19_from_git2/scripts"}
if(!exists('utilsDir')) {utilsDir <- "/home/ubuntu/data/CART19/CART19_from_git2/utils"}
if(!exists('outputDir')) {outputDir <- "/home/ubuntu/data/CART19/CART19_from_git2/data"}
...
intsiteSpecimenMetadata <- read.csv( #TOCHANGE
...
cond_uniq_sites <- readRDS(file.path(outputDir, "condensed_intsites.rds")) #TODO
...
```{r summary_tbl1, child = file.path("/home/ubuntu/data/CART19/CART19_from_git2/scripts", "goi_child_templates", "summary_tbl1.rmd"), eval = nrow(df5) > 0,envir=environment()}
```
